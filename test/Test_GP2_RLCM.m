...
RandomFieldFileBasename = 'Test_GP2_RLCM_RF';
LogLikFileName = 'Test_GP2_RLCM_LogLik.txt';
KrigedRandomFieldFileBasename = 'Test_GP2_RLCM_RF_kriged';
PredictionsFileName = 'Test_GP2_RLCM_Pred.txt';
