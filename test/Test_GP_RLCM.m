...
RandomFieldFileBasename = 'Test_GP_RLCM_RF';
LogLikFileName = 'Test_GP_RLCM_LogLik.txt';
KrigedRandomFieldFileBasename = 'Test_GP_RLCM_RF_kriged';
PredictionsFileName = 'Test_GP_RLCM_Pred.txt';
